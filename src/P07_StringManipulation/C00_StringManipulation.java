...
// codePointAt(): Belirtilen indisteki karakterin Unicode'unu (ASCII kodunu verir)verir. int döndürür.
...
// concat(): Başka bir String'in sonuna bir karakter ekler.birlesirir.biri string olursa digerini string yapar. String döndürür.
...
//iki string birbirine esit mi diye bakar
        String myStr5 = "Hello";
...
// ***** equals(): İki dizgiyi karşılaştırır. Dizeler eşitse doğru, değilse yanlış döndürür. boolean döndürür.Herseye duyarli buyuk kucuk boslu vs
        String myStr7 = "Hello";
        String myStr8 = "Hello";
...
// *** lastIndexOf(): Bir dizede belirtilen karakterlerin  bulundugu son index konumunu verir. int döndürür.Söylenen harfin yada karakterin indeksini verir.ismin son harfi,charAt ile örnegin bankalarda guvenlik
...
// *****replace(): Belirli bir değer için bir dize arar ve belirtilen değerlerin değiştirildiği yeni bir dize döndürür. String döndürür.
        ...
        System.out.println(myStr18.replace('l', 'p'));//output  Heppo olur
...
// *****valueOf(): Bir String nesnesinin ilkel değerini verir. String dönüstürme.Parantez icindekini String yapar,Herseyi degistirebilir.
        String str22 = "22";
